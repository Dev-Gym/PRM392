...
public class DoctorDetailActivity extends AppCompatActivity {
    ...
    private void loadDoctorDetail() {
        ...
        apiService.getMedicalExperts(token).enqueue(new Callback<java.util.List<MedicalExpert>>() {
            @Override
            public void onResponse(Call<java.util.List<MedicalExpert>> call,
                    Response<java.util.List<MedicalExpert>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    for (MedicalExpert doctor : response.body()) {
            ...
            @Override
            public void onFailure(Call<java.util.List<MedicalExpert>> call, Throwable t) {
            }
        });
    }
}